  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-40 bg-[#121212]/90 backdrop-blur-md border-b border-slate-800/80 font-sans">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between gap-4">
        ...
        {/* CENTER LINKS */}
        <div className="flex items-center gap-4 sm:gap-6 text-xs sm:text-sm font-bold shrink-0">
          ...
          >
            <Heart className="w-4 h-4 text-amber-400 fill-amber-400/20 shrink-0" /> Donate
          </Link>
          ...
          >
            <MessageSquare className="w-4 h-4 text-blue-400 shrink-0" /> Discussions
          </Link>
        </div>
        ...
        <div className="shrink-0">
          {isLoggedIn ? (
            ...
            <Link 
              href="/login" 
              className="px-3.5 sm:px-4 py-2 bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs rounded-xl transition shadow-md shadow-blue-600/20 flex items-center gap-1.5 whitespace-nowrap"
            >
