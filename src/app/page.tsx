...
export default function ComeBackHomePage() {
  ...
  return (
    <div className="bg-[#121212] text-slate-100 font-sans selection:bg-blue-500 selection:text-white min-h-screen flex flex-col justify-between">
      ...
      {/* SECTION 5: PLATFORM IMPACT STATS */}
      <section id="stats" className="py-20 px-6 border-b border-slate-800/50 max-w-5xl mx-auto space-y-10">
        <div className="text-center space-y-3">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-5">
          <div className="bg-[#1E1E1E] p-5 rounded-2xl border border-slate-800 text-center space-y-1.5">
            <span className="text-3xl font-black text-blue-400">184</span>
            <p className="text-xs text-slate-400 font-medium">Students Backed</p>
          </div>

          <div className="bg-[#1E1E1E] p-5 rounded-2xl border border-slate-800 text-center space-y-1.5">
            <span className="text-3xl font-black text-emerald-400">₹2.1L+</span>
            <p className="text-xs text-slate-400 font-medium">Fees Raised</p>
          </div>

          <div className="bg-[#1E1E1E] p-5 rounded-2xl border border-slate-800 text-center space-y-1.5">
            <span className="text-3xl font-black text-amber-400">96.4%</span>
            <p className="text-xs text-slate-400 font-medium">Pass Success</p>
          </div>

          <div className="bg-[#1E1E1E] p-5 rounded-2xl border border-slate-800 text-center space-y-1.5">
            <span className="text-3xl font-black text-purple-400">1,420+</span>
            <p className="text-xs text-slate-400 font-medium">Donors Joined</p>
          </div>

          <div className="bg-[#1E1E1E] p-5 rounded-2xl border border-slate-800 text-center space-y-1.5">
            <span className="text-3xl font-black text-rose-400">4</span>
